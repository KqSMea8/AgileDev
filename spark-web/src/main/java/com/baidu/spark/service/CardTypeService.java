...
public interface CardTypeService {
	...
	public void saveCardType(@SecuredObj(clazz=Space.class,idPropertyName="space.id") CardType cardType);
	...
	@Secured("commonVoter")
	@SecuredMethod(permission=SparkPermissionEnum.ADMIN)
	public void deleteCardType(@SecuredObj(clazz=Space.class,idPropertyName="space.id") CardType cardType);
	...
	@Secured("commonVoter")
	@SecuredMethod(permission=SparkPermissionEnum.ADMIN)
	public void updateCardType(@SecuredObj(clazz=Space.class,idPropertyName="space.id")CardType cardType);
	...
	@Secured("commonVoter")
	@SecuredMethod(permission=SparkPermissionEnum.ADMIN)
	public void saveCardProperty(@SecuredObj(clazz=Space.class,idPropertyName="space.id")CardProperty cardProperty,Collection<CardType> originCardTypes);
	...
	@Secured("commonVoter")
	@SecuredMethod(permission=SparkPermissionEnum.ADMIN)
	public void deleteCardProperty(@SecuredObj(clazz=Space.class,idPropertyName="space.id")CardProperty cardProperty);
