<style type="text/css"> 
	...
	#notification-card-body .notification{ font-size: 14px; margin: 0px 8px 10px 0px; padding: 0; }
	#notification-card-body .card-info { border: 1px solid #ddb; background: #ffe; margin: 0px 8px 10px 0px; padding: 0; zoom: 1; line-height: 100%;}
...
<div id="notification-card-body">
	...
	<div class="notification">
	${user.name} operated card ${card.title} in <a href="${serverUrlPrefix}/spaces/${card.space.prefixCode}">${card.space.name}</a> at ${card.lastModifiedTime?if_exists?string("yyyy-MM-dd HH:mm")},details are：		</div>
	<div class="card-info">
		<ul>
	...
	<div class="notification">
	Here is the current card information：
	</div>
	...
	<div class="notification">
		New Attachments are as follows: 
	</div>
	<div class="card-info">
		<ul>
